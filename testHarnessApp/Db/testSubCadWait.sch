...
w 64 2082 100 0 n#30 inhier.c#37.P -464 2080 640 2080 testTimeOut.testTimeOut#25.STOP
w 1048 1682 100 0 n#30 efanouts.Fan1.FLNK 1584 1408 1648 1408 1648 1680 496 1680 496 2080 junction
w 1544 2322 100 0 n#52 testTimeOut.testTimeOut#25.EXPIRED 1088 2272 1392 2272 1392 2320 1744 2320 estringouts.noResp.SLNK
...
w 64 2274 100 0 n#38 inhier.START.P -464 2272 640 2272 testTimeOut.testTimeOut#25.START
...
s 1824 2592 100 0 $Id: testSubCadWait.sch,v 1.5 2005/12/01 15:19:41 cjm Exp $
...
p 1312 286 100 0 -1 def(OUT):$(test)$(prefix)StartTimer.PROC
...
p 2144 542 100 0 -1 def(OUT):$(test)$(prefix)CommSentC.IVAL
...
p -320 686 100 0 -1 def(DOL):$(test)$(prefix)ActiveC
...
p 2128 2014 100 0 -1 def(OUT):$(test)$(prefix)CommSentC.IVAL
...
p 2096 798 100 0 -1 def(OUT):$(test)$(prefix)CommSentC.IMSS
...
p 2064 1726 100 0 -1 def(OUT):$(test)$(prefix)CommSentC.IMSS
...
p 2112 2334 100 0 -1 def(OUT):$(test)$(prefix)CommSentC.IMSS
...
p 160 832 100 0 -1 def(INPB):$(test)$(prefix)CarDisable
...
use testTimeOut 664 2024 100 0 testTimeOut#25
xform 0 864 2176
